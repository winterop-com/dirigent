...
```text
2026-09-26T02:01:15.109+02:00 [info    ] valid                          [validation] code=first-reading document=pipelines/first-reading.yaml checked="document, offline"
...
![A run in the UI: one step named ask, succeeded in 242 milliseconds, its output showing the reflected args.](images/basics/run-first.png)
...
┃ step  ┃ block           ┃ outcome   ┃ after ┃ duration ┃ output                                  ┃
┡━━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━╇━━━━━━━╇━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┩
│ ask   │ http.request    │ succeeded │ -     │ 0.1s     │ status=200  headers={5 keys}  body={3   │
│       │                 │           │       │          │ keys}  body_bytes=452  duration_ms=31   │
...
│ ask   │ http.request    │ succeeded │ -     │ 1        │ 0.0s     │ -     │
│ check │ validate.schema │ succeeded │ ask   │ 1        │ 0.0s     │ -     │
│ send  │ http.request    │ succeeded │ check │ 1        │ 0.1s     │ -     │
└───────┴─────────────────┴───────────┴───────┴──────────┴──────────┴───────┘
...
┃ step  ┃ output                                                                      ┃
┡━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┩
│ ask   │ status=200  headers={5 keys}  body={3 keys}  body_bytes=452  duration_ms=6  │
│ check │ value={9 keys}                                                              │
│ send  │ status=200  headers={5 keys}  body={3 keys}  body_bytes=486  duration_ms=19 │
└───────┴─────────────────────────────────────────────────────────────────────────────┘
```
