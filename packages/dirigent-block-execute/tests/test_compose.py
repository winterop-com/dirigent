...
from dirigent_block_execute.compose import (
...
def install_daemon(monkeypatch: pytest.MonkeyPatch, daemon: FakeComposeDaemon) -> None:
    ...
    monkeypatch.setattr("dirigent_block_execute.compose.connect", fake_connect)
...
from dirigent_block_execute.docker import DockerRunConfig, DockerRunOperator, socket_path  # noqa: E402
