...
ALLOWED: Final[dict[str, set[str]]] = {
    ...
    # The umbrella over the families, which is what an instance installs to have them all.
    "dirigent-blocks": {
        "dirigent-common",
        "dirigent-plugin",
        "dirigent-block-base",
    ...
    "dirigent-block-execute": {"dirigent-common", "dirigent-plugin", "dirigent-block-http"},
    "dirigent-block-http": {"dirigent-common", "dirigent-plugin"},
