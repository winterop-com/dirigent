...
| [playground-reading.json](playground-reading.json) | What the playground's reflection route answers with: a `request` carrying an `args` map of `station` and `day`, and the `url` |
