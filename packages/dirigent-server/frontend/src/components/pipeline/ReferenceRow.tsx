...
function schemaRow(resolution: ReturnType<typeof resolveSchema>, code: string): Found | null {
    switch (resolution.source) {
        case 'unread':
            return null
        case 'missing':
            return { named: null, words: 'not stored', body: null }
        case 'carried': {
            const words = 'carried by this document'
            return { named: null, words, body: <Body title={words} value={resolution.body} /> }
        }
        case 'instance': {
...
function connectionRow(resolution: ReturnType<typeof resolveConnection>): Found | null {
    ...
    if (resolution.source === 'missing') return { named: null, words: 'not configured', body: null }
